...
import { Vector3, Euler } from 'https://unpkg.com/three@0.126.1/build/three.module.js';
  ...
  fetch(jsonFile)
    ...
    .then(jsonData => {
      for (const data of jsonData) {
        ...
        const sphereGeometry = new THREE.SphereGeometry(molecule.sphereRadius, 32, 32);
        const sphereMaterial = new THREE.MeshStandardMaterial({
          color: new THREE.Color(molecule.rgb.x, molecule.rgb.y, molecule.rgb.z),
        });
